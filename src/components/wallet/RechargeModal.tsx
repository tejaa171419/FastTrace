        ...
        <div className="p-6 pt-4">
          ...
          {rechargeStep === 'number' && (
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-medium text-gray-300">Enter New Number</h4>
                <div>
          ...
          {rechargeStep === 'plans' && (
            <div className="space-y-4">
              ...
              {isLoadingPlans ? (
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  <h4 className="text-sm font-medium text-gray-300">Available Plans</h4>
          ...
          {rechargeStep === 'payment' && selectedPlan && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white">Confirm Recharge</h3>
                <Button
                  variant="ghost"
                  size="sm"
          ...
          {rechargeStep === 'processing' && (
            <div className="text-center space-y-6 py-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Processing Recharge</h3>
          ...
          {rechargeStep === 'success' && selectedPlan && (
            <div className="text-center space-y-6 py-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Recharge Successful!</h3>
          ...
          {rechargeStep === 'failed' && (
            <div className="text-center space-y-6 py-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Recharge Failed</h3>
